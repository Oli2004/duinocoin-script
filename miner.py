...
username = "OliKing800"  # Edit this to your username, mind the quotes
                ...
                if job[1] == ducos1:
                    ...
                    if feedback == "GOOD":
                        ...
                        if enableLEDNotification:
                            file = open('/sys/class/leds/{ledaccepted}/brightness','w')
                            file.write('1')
                            file.close()
                            time.sleep(0.3)
                            file = open('/sys/class/leds/{ledaccepted}/brightness','w')
                    ...
                    # If result was incorrect
                        ...
                        # If LED notification is enabled
                        if enableLEDNotification:
                            file = open('/sys/class/leds/{ledrejected}/brightness','w')
                            file.write('1')
                            file.close()
                            time.sleep(0.3)
                            file = open('/sys/class/leds/{ledrejected}/brightness','w')
